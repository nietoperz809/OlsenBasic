...
public class SID
{
     ...
     */
    public static final boolean ANTTI_LANKILA_PATCH = true;
    /**
     ...
     */
    private static final int FIR_N = 125;
    /**
     * Resampling constants. The error in interpolated lookup is bounded by
     * 1.234/L^2, while the error in non-interpolated lookup is bounded by
     * 0.7854/L + 0.4113/L^2, see
     ...
     * resolution of 16 bits this yields L >= 285 and L >= 51473, respectively.
     */
    private static final int FIR_RES_INTERPOLATE = 285;
    /**
     * Resampling constants. The error in interpolated lookup is bounded by
     * 1.234/L^2, while the error in non-interpolated lookup is bounded by
     * 0.7854/L + 0.4113/L^2, see
     ...
     * resolution of 16 bits this yields L >= 285 and L >= 51473, respectively.
     */
    private static final int FIR_RES_FAST = 51473;
    /**
     * Resampling constants. The error in interpolated lookup is bounded by
     * 1.234/L^2, while the error in non-interpolated lookup is bounded by
     * 0.7854/L + 0.4113/L^2, see
     ...
     * resolution of 16 bits this yields L >= 285 and L >= 51473, respectively.
     */
    private static final int FIR_SHIFT = 15;
    /**
     * Resampling constants. The error in interpolated lookup is bounded by
     * 1.234/L^2, while the error in non-interpolated lookup is bounded by
     * 0.7854/L + 0.4113/L^2, see
     ...
     * resolution of 16 bits this yields L >= 285 and L >= 51473, respectively.
     */
    private static final int RINGSIZE = 16384;
    /**
     * Fixpoint constants (16.16 bits).
     */
    private static final int FIXP_SHIFT = 16;
    /**
     * Fixpoint constants (16.16 bits).
     */
    private static final int FIXP_MASK = 0xffff;
    private final Voice[] voice = new Voice[]{new Voice(), new Voice(),
            new Voice()
    };
...
//    private final Potentiometer poty = new Potentiometer();
    private int /* reg8 */bus_value;
    private int /* cycle_count */bus_value_ttl;
     ...
     * Sampling variables.
     */
    private sampling_method sampling;
    /**
     * Sampling variables.
     */
    private int /* cycle_count */cycles_per_sample;
    /**
     * Sampling variables.
     */
    private int /* cycle_count */sample_offset;
    /**
     * Sampling variables.
     */
...
//                0.97);
                                            ...
                                            double filter_scale)
    {
        ...
        if (method != sampling_method.SAMPLE_RESAMPLE_INTERPOLATE
                && method != sampling_method.SAMPLE_FAST)
        {
            sample = null;
            fir = null;
            return true;
...
// --Commented out by Inspection START (1/9/2017 7:20 AM):
...
//						Hh);
//	}
// --Commented out by Inspection STOP (1/9/2017 7:20 AM)
...
// --Commented out by Inspection STOP (1/9/2017 7:20 AM)
    ...
    public int /* reg8 */read (int /* reg8 */offset)
    {
        ...
        {
            case 0x19:
                return 0xff; //potx.readPOT();
            case 0x1a:
                return 0xff; //poty.readPOT();
            case 0x1b:
...
// --Commented out by Inspection STOP (1/9/2017 7:20 AM)
     ...
     * @return
     */
    private int clock_fast (int delta_t, short buf[], int n,
                            int interleave)
    {
        int s = 0;
     ...
     * @param delta_t
     */
    private void clock (int /* cycle_count */delta_t)
    {
        int i;
...
// --Commented out by Inspection STOP (1/9/2017 7:20 AM)
     ...
     * @return
     */
    private int clock_interpolate (int delta_t, short buf[], int n,
                                   int interleave)
    {
        int s = 0;
        int i;
     ...
     * @return
     */
    private int clock_resample_interpolate (int delta_t, short buf[],
...
// --Commented out by Inspection STOP (1/9/2017 7:20 AM)
     ...
     * @return
     */
    private int clock_resample_fast (int delta_t, short buf[], int n,
                                     int interleave)
    {
        int s = 0;
    ...
    public class State
    {
        public final char[] sid_register = new char[0x20];
        public final int[] /* reg24 */accumulator = new int[3];
        public final int[] /* reg24 */shift_register = new int[3];
        public final int[] /* reg16 */rate_counter = new int[3];
        public final int[] /* reg16 */rate_counter_period = new int[3];
        public final int[] /* reg16 */exponential_counter = new int[3];
        public final int[] /* reg16 */exponential_counter_period = new int[3];
        public final EnvelopeGenerator.State[] envelope_state = new EnvelopeGenerator.State[3];
        public final boolean[] hold_zero = new boolean[3];
        final int[] /* reg8 */envelope_counter = new int[3];
